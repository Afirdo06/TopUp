...
<head>
    ...
    <style>
        ...
        /* Add New Game Button Style */
        .btn-add-game {
            background-color: #6c5ce7;  /* Warna yang sama dengan tombol Add New Package */
            color: white;
            font-size: 16px;
            font-weight: bold;
            padding: 12px 20px;
...
<body>
    ...
    <div class="main-content">
        ...
        <a href="/admin/games/add" class="btn-add-game mb-3">Tambah Game Baru</a>
                        ...
                        <?php foreach ($games as $game): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/admin/games/delete/<?= $game['id'] ?>" class="btn btn-danger btn-sm"
                                        onclick="return confirm('Apakah Anda yakin ingin menghapus game ini?')">Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
